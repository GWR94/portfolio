...
export const tiles: ProjectTile[] = [
  ...
  },
  {
    ...
    desc: "Classic 1-2 player game of Tic-Tac-Toe, online or against a Minimax AI opponent.",
    href: "https://tictactoe.jamesgower.dev",
    color: "#999285",
    sourceCode: "https://github.com/GWR94/tic-tac-toe",
    tags: ["React", "Redux", "TypeScript", "Socket.io"],
    bento: { colSpan: 4 },
  },
  {
